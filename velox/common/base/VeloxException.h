...
// An error raised when memory pool exceeded limits.
inline constexpr auto kMemPoolCapExceeded = "MEM_POOL_CAP_EXCEEDED"_fs;

// An error raised when memory is aborted.
inline constexpr auto kMemPoolAborted = "MEM_POOL_ABORTED"_fs;
